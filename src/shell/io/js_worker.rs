use super::{Input, InputStream, Output, OutputSink, Result as IoResult};
...
pub fn setup(_cfg: Cfg) -> (impl InputStream, impl OutputSink) {
    ...
    let reply_sender = unfold((), |_, out: IoResult| async move {
