...
mod tests {
    ...
    fn catalog_wires_are_canonical_bounded_and_have_stable_golden_commitments() {
        ...
        assert_eq!(
            ...
            [
                0x68, 0x9d, 0x27, 0xf6, 0x4c, 0x7d, 0x86, 0x25, 0x5d, 0x84, 0xb8, 0x54, 0xfb, 0x83, 0x45, 0x7d,
                0xcd, 0xda, 0x9e, 0x55, 0xba, 0xb3, 0x27, 0xd9, 0xdd, 0x65, 0xde, 0x70, 0x9d, 0x12, 0x07, 0x79,
            ]
        );
        assert_eq!(
            Hash::digest(b"vos/catalog/test/golden/call", &[&call_bytes]).0,
            [
                0x6c, 0x47, 0x68, 0xef, 0x45, 0x63, 0xf6, 0x9d, 0x81, 0x29, 0x14, 0x9c, 0xf2, 0x02, 0x29, 0xf5,
                0xdf, 0xd3, 0x8d, 0x36, 0x0b, 0xf1, 0x95, 0x40, 0x1d, 0xc4, 0x87, 0x9f, 0xc9, 0x94, 0x30, 0x19,
            ]
        );
        assert_eq!(
            Hash::digest(b"vos/catalog/test/golden/page", &[&page_bytes]).0,
            [
                0x8a, 0x66, 0xba, 0xea, 0x69, 0xf9, 0xab, 0xe7, 0xbc, 0xc3, 0xa6, 0x71, 0x32, 0x32, 0xa3, 0x94,
                0xf6, 0x35, 0x0d, 0xb1, 0x57, 0x64, 0x5d, 0x36, 0xcf, 0xd3, 0x7b, 0x6c, 0x71, 0x6f, 0x3f, 0x64,
            ]
        );
    }
