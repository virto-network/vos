...
mod tests {
    ...
    fn catalog_wires_are_canonical_bounded_and_have_stable_golden_commitments() {
        ...
        assert_eq!(
            ...
            Hash([
                0xc3, 0xd1, 0x79, 0xf1, 0x6f, 0x08, 0xec, 0xfe, 0xc4, 0xff, 0x95, 0x02, 0xbb, 0x0b,
                0x95, 0x3a, 0x87, 0x36, 0xa4, 0xae, 0xf0, 0x1f, 0x8d, 0x0d, 0x76, 0x23, 0x5e, 0x7b,
                0x65, 0xf7, 0xfb, 0xac,
            ])
        );
        assert_eq!(
            ...
            Hash([
                0x12, 0xb2, 0x99, 0x70, 0x93, 0x1a, 0x5a, 0x41, 0x5f, 0x80, 0x70, 0x34, 0x93, 0x67,
                0x55, 0x98, 0xdf, 0xec, 0x6c, 0xa5, 0x78, 0xa4, 0xde, 0x62, 0x38, 0x02, 0xc9, 0x3d,
                0x13, 0xed, 0x49, 0x9b,
            ])
        );
        assert_eq!(
            ...
            Hash([
                0xc1, 0x60, 0x8a, 0xc2, 0xf2, 0xda, 0x64, 0x1e, 0x69, 0x69, 0x84, 0x3d, 0xcd, 0xab,
                0x1f, 0x5e, 0xf0, 0x11, 0xc4, 0xe6, 0xc7, 0x1f, 0x11, 0x83, 0x9a, 0xfa, 0x42, 0xcf,
                0x19, 0xc2, 0xc7, 0x74,
            ])
        );
    }
