...
mod tests {
    ...
    fn catalog_wires_are_canonical_bounded_and_have_stable_golden_commitments() {
        ...
        assert_eq!(
            ...
            [
                169, 82, 60, 178, 51, 125, 58, 10, 148, 144, 160, 188, 230, 135, 3, 196, 132, 101,
                198, 0, 240, 91, 158, 249, 9, 30, 207, 214, 123, 133, 220, 219,
            ]
        );
        assert_eq!(
            Hash::digest(b"vos/catalog/test/golden/call", &[&call_bytes]).0,
            [
                239, 192, 182, 173, 184, 30, 196, 182, 187, 31, 113, 251, 83, 148, 28, 182, 37,
                119, 110, 211, 21, 102, 159, 50, 21, 35, 64, 174, 174, 21, 28, 25,
            ]
        );
        assert_eq!(
            Hash::digest(b"vos/catalog/test/golden/page", &[&page_bytes]).0,
            [
                188, 166, 196, 32, 165, 220, 45, 100, 201, 114, 198, 238, 121, 146, 41, 10, 100,
                118, 116, 150, 215, 180, 102, 129, 211, 12, 252, 239, 56, 179, 76, 103,
            ]
        );
    }
