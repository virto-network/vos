...
mod tests {
    ...
    fn catalog_wires_are_canonical_bounded_and_have_stable_golden_commitments() {
        ...
        assert_eq!(
            ...
            Hash([
                223, 108, 116, 137, 8, 247, 131, 125, 161, 48, 198, 36, 191, 255, 212, 220, 111, 6,
                174, 94, 140, 135, 121, 29, 64, 131, 169, 155, 92, 100, 221, 154,
            ])
        );
        assert_eq!(
            Hash::digest(b"vos/catalog/test/golden/call", &[&call_bytes]),
            Hash([
                51, 148, 2, 173, 30, 184, 4, 201, 81, 149, 82, 8, 126, 162, 203, 14, 4, 224, 95,
                186, 35, 178, 22, 68, 73, 83, 199, 155, 27, 114, 190, 209,
            ])
        );
        assert_eq!(
            Hash::digest(b"vos/catalog/test/golden/page", &[&page_bytes]),
            Hash([
                244, 114, 92, 103, 67, 207, 118, 123, 195, 111, 74, 137, 72, 153, 241, 221, 49, 3,
                115, 7, 228, 180, 10, 65, 74, 118, 9, 171, 44, 73, 6, 195,
            ])
        );
    }
