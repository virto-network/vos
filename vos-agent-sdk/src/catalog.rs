...
mod tests {
    ...
    fn catalog_wires_are_canonical_bounded_and_have_stable_golden_commitments() {
        ...
        assert_eq!(
            ...
            [
                0x23, 0x08, 0x82, 0x40, 0x7a, 0x3c, 0x5d, 0xae, 0x65, 0x68, 0x48, 0x30, 0x2b, 0xe3, 0x96, 0xc9,
                0x18, 0x61, 0xf2, 0x55, 0x02, 0xe0, 0xb5, 0xa0, 0xd9, 0x91, 0x7f, 0x06, 0xc8, 0xb2, 0xd1, 0x05,
            ]
        );
        assert_eq!(
            Hash::digest(b"vos/catalog/test/golden/call", &[&call_bytes]).0,
            [
                0x85, 0xc9, 0x05, 0x3e, 0x28, 0x27, 0xff, 0xc9, 0xf3, 0x0c, 0xf3, 0x94, 0x5a, 0x2b, 0x81, 0x26,
                0xdb, 0x05, 0x04, 0x28, 0x2a, 0x54, 0xa3, 0x51, 0xcf, 0x6e, 0xbd, 0xb3, 0x91, 0xfb, 0x8c, 0x4f,
            ]
        );
        assert_eq!(
            Hash::digest(b"vos/catalog/test/golden/page", &[&page_bytes]).0,
            [
                0x6a, 0x80, 0xc2, 0x2b, 0x00, 0xb6, 0x23, 0x11, 0x22, 0xb9, 0x8f, 0xa2, 0x41, 0x1c, 0x29, 0x5f,
                0x4d, 0x10, 0x82, 0x64, 0x64, 0x92, 0xdb, 0x99, 0x00, 0xb3, 0x69, 0x07, 0xa3, 0x12, 0x68, 0x13,
            ]
        );
    }
