...
mod tests {
    ...
    fn catalog_wires_are_canonical_bounded_and_have_stable_golden_commitments() {
        ...
        assert_eq!(
            ...
            Hash([
                169, 204, 200, 2, 119, 100, 26, 154, 234, 74, 194, 233, 191, 4, 104, 125, 147, 111,
                129, 195, 198, 158, 140, 28, 55, 159, 183, 41, 24, 152, 170, 89,
            ])
        );
        assert_eq!(
            Hash::digest(b"vos/catalog/test/golden/call", &[&call_bytes]),
            Hash([
                181, 191, 36, 228, 195, 22, 177, 209, 62, 93, 105, 186, 165, 76, 2, 138, 228, 119,
                173, 92, 157, 216, 183, 240, 7, 59, 216, 111, 222, 8, 243, 71,
            ])
        );
        assert_eq!(
            Hash::digest(b"vos/catalog/test/golden/page", &[&page_bytes]),
            Hash([
                93, 211, 124, 228, 32, 103, 78, 15, 178, 159, 163, 156, 241, 129, 209, 251, 182,
                76, 27, 203, 204, 132, 5, 252, 41, 39, 203, 197, 60, 73, 77, 26,
            ])
        );
    }
