...
mod tests {
    ...
    fn catalog_wires_are_canonical_bounded_and_have_stable_golden_commitments() {
        ...
        assert_eq!(
            ...
            [
                89, 187, 24, 124, 92, 175, 67, 224, 192, 109, 216, 19, 138, 147, 39, 112, 209, 1,
                228, 184, 45, 140, 229, 9, 23, 53, 247, 164, 12, 155, 169, 106,
            ]
        );
        assert_eq!(
            Hash::digest(b"vos/catalog/test/golden/call", &[&call_bytes]).0,
            [
                101, 206, 194, 102, 152, 236, 33, 86, 77, 17, 43, 196, 126, 42, 49, 117, 225, 123,
                225, 42, 112, 58, 3, 94, 153, 149, 76, 197, 142, 24, 19, 143,
            ]
        );
        assert_eq!(
            Hash::digest(b"vos/catalog/test/golden/page", &[&page_bytes]).0,
            [
                136, 66, 27, 48, 138, 148, 233, 151, 71, 229, 60, 177, 71, 5, 235, 239, 242, 45,
                131, 148, 92, 198, 27, 246, 155, 57, 26, 215, 20, 59, 209, 89,
            ]
        );
    }
