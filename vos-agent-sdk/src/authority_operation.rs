...
mod tests {
    ...
    fn aoc5_aop5_and_aoi1_are_distinct_bounded_canonical_golden_wires() {
        ...
        assert_eq!(
            ...
            [
                47, 121, 149, 48, 206, 137, 29, 129, 175, 7, 234, 81, 199, 228, 83, 134, 165, 62,
                255, 5, 112, 190, 149, 174, 143, 113, 136, 110, 184, 51, 184, 233,
            ]
        );
        ...
        assert_eq!(
            ...
            [
                186, 199, 123, 234, 104, 228, 161, 170, 189, 70, 108, 84, 76, 91, 11, 218, 110,
                100, 220, 252, 105, 28, 152, 254, 8, 154, 76, 142, 149, 196, 128, 173,
            ]
        );
        ...
        assert_eq!(
            ...
            [
                81, 174, 27, 81, 164, 200, 190, 237, 85, 163, 248, 198, 4, 141, 246, 65, 63, 59,
                115, 159, 236, 219, 245, 32, 37, 86, 222, 95, 137, 113, 167, 135,
            ]
        );
    }
    ...
    fn pca2_is_a_distinct_canonical_tombstone_checkable_application_proof() {
        ...
        assert_eq!(
            ...
            [
                16, 119, 227, 9, 207, 237, 13, 175, 63, 65, 24, 208, 139, 100, 220, 182, 161, 206,
                98, 135, 8, 183, 192, 47, 134, 153, 197, 37, 140, 68, 18, 155,
            ]
        );
