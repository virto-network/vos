...
mod tests {
    ...
    fn aoc4_aop4_and_aoi1_are_distinct_bounded_canonical_golden_wires() {
        ...
        assert_eq!(
            ...
            [
                179, 91, 16, 76, 180, 140, 213, 232, 71, 83, 169, 136, 99, 143, 178, 67, 246, 61,
                166, 92, 200, 220, 232, 181, 198, 220, 227, 178, 105, 228, 58, 92,
            ]
        );
        ...
        assert_eq!(
            ...
            [
                63, 150, 80, 20, 248, 7, 50, 138, 51, 99, 12, 230, 138, 137, 53, 92, 209, 90, 76,
                120, 79, 38, 48, 115, 21, 127, 113, 168, 254, 242, 209, 133,
            ]
        );
        ...
        assert_eq!(
            ...
            [
                247, 181, 21, 160, 118, 244, 61, 189, 38, 217, 220, 154, 81, 97, 204, 216, 35, 6,
                146, 251, 91, 132, 8, 70, 58, 42, 249, 189, 55, 228, 35, 250,
            ]
        );
    }
    ...
    fn pca1_is_a_distinct_canonical_tombstone_checkable_application_proof() {
        ...
        assert_eq!(
            ...
            [
                128, 167, 69, 7, 90, 20, 236, 219, 242, 79, 34, 216, 208, 113, 8, 119, 84, 99, 199,
                116, 197, 164, 195, 221, 87, 168, 111, 249, 187, 126, 35, 240,
            ]
        );
