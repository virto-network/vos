...
and their costs, see [Security Analysis](./security-analysis.md).
...
lifetime. See [Security Analysis](./security-analysis.md), section 2
...
[Privacy Analysis](./privacy-layers.md)). The smallest bucket is 1KB.
