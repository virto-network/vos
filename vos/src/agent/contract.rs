...
pub const CONTROL_SCHEMA_ID: Hash = Hash([
    0xa6, 0x5e, 0x16, 0x31, 0x63, 0xd6, 0xe9, 0xdc, 0x69, 0xd2, 0xcf, 0x42, 0xd1, 0x49, 0x32, 0xc0,
    0x13, 0x57, 0x23, 0x29, 0xe6, 0x1c, 0xe0, 0x05, 0x3e, 0xb9, 0x34, 0x41, 0x73, 0xc3, 0xbf, 0x85,
]);
...
mod tests {
    ...
    fn control_schema_pin_matches_its_canonical_descriptor() {
        assert_eq!(
            ...
            *b"vos-agent-runtime-abi-20260831r6"
        );
        assert_eq!(
