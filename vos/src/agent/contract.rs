...
pub const CONTROL_SCHEMA_ID: Hash = Hash([
    0x64, 0x33, 0xcb, 0x4b, 0x3f, 0xa9, 0xfc, 0xde, 0x89, 0xcb, 0x09, 0x96, 0x86, 0x27, 0xa3, 0xb5,
    0x88, 0xa1, 0x9b, 0x94, 0xb1, 0xd4, 0x58, 0x9c, 0xb7, 0xc8, 0x22, 0x5a, 0x84, 0xf7, 0x38, 0x84,
]);
...
mod tests {
    ...
    fn control_schema_pin_matches_its_canonical_descriptor() {
        assert_eq!(
            ...
            *b"vos-agent-runtime-abi-20260906r0"
        );
        assert_eq!(
