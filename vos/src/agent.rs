...
pub const RUNTIME_ABI_ID: Hash = Hash(*b"vos-agent-runtime-abi-20260906r0");
...
pub const STANDARD_RUNTIME_PROGRAM_ID: ProgramId = ProgramId([
    0x8e, 0xd7, 0x83, 0xfc, 0xbe, 0x97, 0xd0, 0x07, 0x84, 0xca, 0xa7, 0x5a, 0x3f, 0x63, 0x9f, 0x2a,
    0x6e, 0x8e, 0x53, 0x6d, 0x1d, 0x84, 0x43, 0xb2, 0xa8, 0x1f, 0x51, 0x74, 0x28, 0x7c, 0xaf, 0xdb,
]);
