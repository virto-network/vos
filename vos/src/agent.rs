...
pub const RUNTIME_ABI_ID: Hash = Hash(*b"vos-agent-runtime-abi-20260829v3");

/// Program identity of the bundled standard runtime artifact.
pub const STANDARD_RUNTIME_PROGRAM_ID: ProgramId = ProgramId([
    0xb6, 0x97, 0x65, 0x27, 0xfd, 0x86, 0x24, 0x5c, 0x0a, 0x31, 0x3c, 0xad, 0x0e, 0xf1, 0x58, 0x16,
    0x27, 0x22, 0x7b, 0x67, 0xfb, 0x9d, 0x7b, 0x2d, 0xe6, 0x98, 0x26, 0x67, 0xb9, 0x2e, 0xef, 0x14,
]);
