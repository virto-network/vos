...
use super::{
    ...
    ContinuationSnapshotV2, CrdtChangeV2, CrdtDispatchV2, Hash, ImportedBlobV2, ProgramId,
    REFINE_ENTRY_IC, RefineImportsV2, RoleCredentialV2, TARGET_ACTOR_HANDLE_SLOT, V2Wire,
    WorkEnvelopeV2,
};
                    ...
                    if let Some(work) = suspension_work {
                        ...
                        let token_len = write_checkpoint_token(
                            ...
                            &CheckpointTokenV2 {
                                ...
                                base: work.base.clone(),
                                work_hash: work.hash(),
                                resume_work: (work.workflow_step != 0).then(|| work.clone()),
                                base_causal_height: work.base_causal_height,
                                change: crdt_dispatch(work, 0),
                                expected,
