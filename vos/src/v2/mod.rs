...
pub use contracts::{
    ...
    ActorGenesisV2, ActorSliceInputV2, ActorSliceOutputV2, ActorWriteV2, AuthorizationEvidenceV2,
    AwaitResumeV2, BlobRefV2, CausalCallContextV2, CheckpointTokenV2, ConsistencyBaseV2,
    ConsistencyModeV2, ContinuationChangeV2, CrdtChangeV2, CrdtDispatchV2, CrdtMaterializationV2,
...
pub const VOS_SERVICE_PROGRAM_ID: ProgramId = ProgramId([
    0xf3, 0xe5, 0x3c, 0xf1, 0xd1, 0xbe, 0x03, 0x08, 0xe6, 0x1a, 0x6a, 0x69, 0xa2, 0xce, 0xd8, 0x85,
    0xfe, 0x1a, 0xa4, 0x96, 0xe1, 0x34, 0xad, 0xbb, 0x16, 0x36, 0x6f, 0xbc, 0x0a, 0x37, 0x24, 0xdd,
]);
