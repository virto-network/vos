...
fn assert_bundled_space_authority_matches_canonical_program() {
    ...
    assert_eq!(
        ...
        "d59455d2f638119ad4a3a6a8e127d84a0dad87d79de320a788f5783aad17b501",
...
fn signed_service_package_runs_and_reopens_through_the_space_daemon() {
    ...
    vosx_ok(
        data.path(),
        config.path(),
        &["space", "publish", space, "counter", &package_source],
    );
    vosx_ok(
        data.path(),
        config.path(),
...
fn boot_admin_with_service(
    ...
    vosx_ok(
        data_a.path(),
        cfg_a.path(),
        &["space", "publish", space, "crdt-counter", &counter_source],
    );
    vosx_ok(
        data_a.path(),
        cfg_a.path(),
