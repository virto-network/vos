...
const AGENT_RUNTIME_BLAKE2B_256: [u8; 32] = [
    0x03, 0x93, 0x93, 0xa4, 0x0e, 0x61, 0xe2, 0x50, 0x96, 0x53, 0x3d, 0xed, 0xd2, 0x43, 0x54, 0xad,
    0x38, 0xfb, 0x2d, 0x2e, 0xc0, 0x51, 0x82, 0xbc, 0x08, 0xd6, 0x0d, 0x11, 0xff, 0xeb, 0x29, 0x33,
];
