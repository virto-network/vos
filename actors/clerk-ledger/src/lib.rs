...
pub const CLERK_APPLY_TASK_HASH: [u8; 32] = [
    0xe4, 0x50, 0x27, 0xd0, 0xfa, 0x6e, 0x60, 0x2a, 0x07, 0x7d, 0x25, 0xa1, 0xa1, 0x48, 0xc1, 0x20,
    0x81, 0x0d, 0x9b, 0xfd, 0x60, 0x70, 0x0f, 0xb8, 0xaf, 0x1e, 0xd7, 0xd3, 0x86, 0x8e, 0xe2, 0x43,
];
