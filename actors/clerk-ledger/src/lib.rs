...
pub const CLERK_APPLY_TASK_HASH: [u8; 32] = [
    0x9e, 0x7f, 0xf9, 0xca, 0xee, 0x2b, 0xdb, 0x73, 0xb1, 0xde, 0xfa, 0x12, 0x17, 0xa8, 0xb1, 0x45,
    0x24, 0xe3, 0xc9, 0x23, 0x9a, 0x49, 0x26, 0xf2, 0x03, 0xaf, 0xfc, 0xb9, 0x8d, 0xf7, 0xf7, 0xa9,
];
