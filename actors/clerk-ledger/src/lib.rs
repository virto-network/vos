...
pub const CLERK_APPLY_TASK_HASH: [u8; 32] = [
    0xe3, 0x28, 0x9a, 0xe3, 0x85, 0x15, 0x65, 0xb8, 0x69, 0xc4, 0xf9, 0xd8, 0xc0, 0xbc, 0x37, 0x12,
    0x18, 0x4d, 0xd6, 0xad, 0x35, 0xde, 0x24, 0xc9, 0x12, 0x36, 0x8d, 0xb5, 0x4a, 0x24, 0xff, 0xa6,
];
