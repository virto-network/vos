...
pub const CLERK_APPLY_TASK_HASH: [u8; 32] = [
    0x75, 0xf6, 0xfa, 0x54, 0xbe, 0x77, 0x45, 0xa7, 0x05, 0x45, 0xd7, 0x15, 0x60, 0x9b, 0x1a, 0x96,
    0x45, 0x58, 0x6d, 0xb9, 0x74, 0x64, 0xba, 0x9a, 0x44, 0xbc, 0x4e, 0x39, 0x98, 0x00, 0xc4, 0x7d,
];
