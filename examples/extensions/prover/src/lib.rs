...
const VOUCHER_CHECK_COMMITMENT: [u8; 32] = [
    0xb2, 0xa2, 0xec, 0x38, 0xf5, 0x2f, 0x80, 0x8f, 0xdf, 0x1f, 0x46, 0xed, 0x70, 0x5b, 0x36, 0xe2,
    0xc9, 0xa1, 0xca, 0x77, 0x74, 0xc0, 0xb8, 0x8b, 0xe5, 0xd0, 0x16, 0x49, 0x17, 0xfe, 0x8e, 0x6e,
];
