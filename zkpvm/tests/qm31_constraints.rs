//! Recursion build P3 (foundation piece): constrain explicit **QM31
//! (SecureField) arithmetic** in-AIR as 4×M31, the idiom the FriFold and
//! OodsComposition verifier-AIR chips need. The design flagged this as
//! unexercised — no existing zkpvm chip constrains explicit extension-field ops
//! (SecureField appears only in prover-side interaction-trace return types).
//!
//! ## Approach
//!
