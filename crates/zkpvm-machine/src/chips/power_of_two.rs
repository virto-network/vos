...
impl BuiltInComponent for PowerOfTwoChip {
    ...
    fn generate_interaction_trace(
        ...
        let shift_amount = zkpvm_trace::original_base_column!(component_trace, Column::ShiftAmount);
        let power_val = zkpvm_trace::original_base_column!(component_trace, Column::PowerVal);
    ...
    fn add_constraints<E: EvalAtRow>(
        ...
        let power_val = zkpvm_trace::trace_eval!(trace_eval, Column::PowerVal);
