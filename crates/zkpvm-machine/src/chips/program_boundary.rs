...
impl BuiltInComponent for ProgramBoundaryChip {
    ...
    fn generate_interaction_trace(
        ...
        let init_ts = zkpvm_trace::original_base_column!(component_trace, Column::InitialTimestamp);
        let init_pc = zkpvm_trace::original_base_column!(component_trace, Column::InitialPc);
        let final_next_ts = zkpvm_trace::original_base_column!(component_trace, Column::FinalNextTimestamp);
        let final_next_pc = zkpvm_trace::original_base_column!(component_trace, Column::FinalNextPc);
    ...
    fn add_constraints<E: EvalAtRow>(
        ...
        let init_ts = zkpvm_trace::trace_eval!(trace_eval, Column::InitialTimestamp);
        let init_pc = zkpvm_trace::trace_eval!(trace_eval, Column::InitialPc);
        let final_next_ts = zkpvm_trace::trace_eval!(trace_eval, Column::FinalNextTimestamp);
        let final_next_pc = zkpvm_trace::trace_eval!(trace_eval, Column::FinalNextPc);
