...
* **Step 5 (running sum) OPEN — architectural cliff confirmed**: the POC chip proves *which entries were looked up* but not that they compose into `k·G`.  Three options were investigated this session:
