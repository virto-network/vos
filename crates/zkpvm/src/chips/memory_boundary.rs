...
impl BuiltInComponent for MemoryBoundaryChip {
    ...
    fn add_constraints<E: EvalAtRow>(
        ...
        let addr = crate::trace::trace_eval!(trace_eval, Column::Address);
...
impl BuiltInProverComponent for MemoryBoundaryChip {
    fn generate_main_trace(&self, side_note: &mut SideNote) -> FinalizedTrace {
        ...
        let log_size = if num_entries == 0 {
            ...
            crate::trace::utils::ceil_log2_at_least_lanes(num_entries as usize)
        };
    ...
    fn generate_interaction_trace(
        ...
        let addr = crate::trace::original_base_column!(component_trace, Column::Address);
